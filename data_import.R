...
# the code file, where this and the other 7 scripts should be saved:
...
# Import data from Iberia database https://researchdata.reading.ac.uk/343/ and save csv in datafile to file data/
iberia_charcoal_records <- rio::import("data/iberia_charcoal_records_v3.xlsx") %>% 
