...
char_data <- iberia_charcoal_records %>% 
  ...
  # dplyr::filter(dplyr::between(INTCAL2020_median, 0, 15000)) %>%  #Limit data to approximate data range;
  ...
  dplyr::mutate(macro_micro = dplyr::if_else(entity_name %in% c("Abi 05/07_100minus",
                                                                "ADP 01/06_100minus",
                                                                "Baza section",
                                                                "BSM08",
